...
public class TopologicalSort<V> {
	...
	public TopologicalSort(DirectedGraph<V> g) {
		DirectedCycle<V> cycleChecker = new DirectedCycle<>(g);
		...
		Queue<V> postOrder = new LinkedList<>(dfo.postOrder());

		while (!postOrder.isEmpty()) {
			ts.add(postOrder.poll());
		}
	...
	private static void test2() {
		...
		anziehGraph.addEdge("Schal", "Hose"); // Kante führt zu Zyklus
