 ...
 * Mit g.addEdge(v,w, weight) wird eine gerichtete Kante von v nach w mit dem
 * Gewicht weight einfügt.
 * Falls kein Gewicht angegeben wird, dann ist das Gewichte implizit auf 1
 * gesetzt.
