...
public interface FrequencyTable<T> extends Iterable<Element<T>>{
	...
	/**
	 * F&uuml;gt das Element w mit der H&auml;ufigkeit f zu dieser Tabelle dazu. 
	...
	/**
	 * Liefert das Element mit seiner Häufigkeit zur&uuml;ck, das mit seiner H&auml;ufigkeit an Position pos steht.
	 * get(0) liefert das häufigste Element zurück, 
	 * get(1) liefert das zweithäufigste Element zurück, usw.
	 * @param pos Position.
	 * @return Element mit H&auml;ufigkeit oder null, 
