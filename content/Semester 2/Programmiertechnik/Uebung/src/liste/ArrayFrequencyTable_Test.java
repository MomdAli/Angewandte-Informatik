...
public class ArrayFrequencyTable_Test {
	...
	private static void test1() {
		// Test von add:
		FrequencyTable<String> tab1 = new ArrayFrequencyTable<String>();
		tab1.add("das");
		tab1.add("ist");
		tab1.add("ein",2);
		tab1.add("Test");
		...
		// Test von addAll:
		FrequencyTable<String> tab2 = new ArrayFrequencyTable<String>();
		tab2.add("das",2);
		tab2.add("ist",4);
		tab2.add("kurzer");
		tab2.add("Text");
	...
	private static void test2() throws FileNotFoundException, IOException {
		FrequencyTable<String> tab = new ArrayFrequencyTable<String>();
